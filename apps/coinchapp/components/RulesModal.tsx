  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Un double (deux cartes de même valeur posées à la suite) ou un sandwich (deux cartes de même valeur séparées par une seule autre) : le premier qui tape le tas le remporte, peu importe le tribut en cours. Une figure ou un as qui répond à un tribut en ouvre toujours un nouveau (sur le nombre d'essais plein) - il ne compte jamais comme un double avec la carte qui avait ouvert le tribut qu'il vient de payer. À distance, seul le temps de réaction mesuré sur son propre appareil compte, jamais le temps réseau.",
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "A double (2 same-rank cards played back to back) or a sandwich (2 same-rank cards separated by exactly one other): first to slap the pile takes it, regardless of any tribute in progress. A figure or ace answering a tribute always opens a brand new one (full attempt count) - it never counts as a double against the card that opened the tribute it just paid off. Remotely, only the reaction time measured on your own device counts, never network time.",
      },
      {
        heading: "False slap",
